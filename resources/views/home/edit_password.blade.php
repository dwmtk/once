                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('UserController@edit_password_post') }}" onSubmit="return dialog('パスワードを変更しますか？')">
                        ...
                        <div class="form-group row">
                            <label for="password_old" class="col-md-4 col-form-label text-md-right">現在のパスワード</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">新しいパスワード<br>（確認のため再度入力してください）</label>
